...
export const SEVERITY_TOKENS: Record<VitalSeverity, {
  ...
  normal: {
    tile: 'var(--bg-tinted, var(--bg-card-solid))',
    tileBorder: 'var(--border-light)',
    badge: 'var(--color-success-bg)',
    text: 'var(--text-primary)',
    accent: 'var(--accent-primary)',
    ring: 'transparent',
  },
  warning: {
    tile: 'var(--color-warning-bg)',
    tileBorder: 'color-mix(in srgb, var(--color-warning) 32%, transparent)',
  ...
  danger: {
    tile: 'var(--color-danger-bg)',
    tileBorder: 'color-mix(in srgb, var(--color-danger) 35%, transparent)',
    badge: 'var(--color-danger-bg)',
