...
export default function AdminSupportPage() {
  ...
  return (
    <SaPage title="Support Operations" subtitle="Tenant diagnostics, user lookup, support access controls, and platform announcements.">

      <SaCard title="Tenant lookup & diagnostics" meta={`${filteredOrgs.length} of ${organizations.length}`}>
      ...
      <SaCard title="User lookup" meta={`Showing up to 50 of ${users.length}`}>
        <div className="sa-filter-bar">
          <input
            type="search"
